...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.001-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.003-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.005-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.006-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.007-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.008-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.009-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.010-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.011-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.012-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.014-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.015-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.016-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.018-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.019-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.020-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.021-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.022-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.024-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.025-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.026-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.027-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.028-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.029-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.030-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.031-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.032-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.033-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.037-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.039-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.040-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
...
<figure class="extend">
    <img src="{{ 'cdk-aws-community-day-br-2021-.042-min.png' | media(page) }}" width="752" height="475" alt="" style="border: 1px solid #BBB" />
</figure>
