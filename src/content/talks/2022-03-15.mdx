...
eventDate: "2022-03-15 19h00"
---

import TalkImage from "../../components/widgets/TalkImage.astro";

<TalkImage src="/talks/showmethecode.jpg" alt="Show me the code" title="Show me the code" />
...
<div class='yt-frame'><iframe width="560" height="315" src="https://www.youtube.com/embed/wmlMag5YTrY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
